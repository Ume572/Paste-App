...
const Paste = () => {
  ...
  // jb bhi delete pr click kru to  Jo pasteId hai wo remove ho jaye uska funtion niche likha huaa hai and toast bhi aa gya
  const handleDelete = (id) => {
    dispatch(removeFromPastes(id));    // is line ka mtlb hai ki redux ko bolo ki pasteId wala paste ko delete kr do
    // dispatch() => iska mtlb ahi kisi action ko trigger krna taki wo reducer fn mai jake state ko update kre. mtlb ye redux ko bol rha hai ki " ye kam kro"
    // removerfromPastes(...) =>  ye ek action fn h jo tumne slice mai bnaya 
    // pasteId => ye tum us fn ko parameter de rhe ho , jisse pta chael kon sa paste delete krna hai
                  ...
                  <div className="flex flex-col gap-y-4 sm:items-end">
                    <div className="flex gap-2 flex-wrap sm:flex-nowrap">
                      ...
                      <button
                        ...
                        onClick={() => {
                          navigator.clipboard.writeText(paste?.content);    // navigator => JavaScript ka browser object hai jo browser-related cheezein control karta hai (jaise clipboard, geolocation, permissions, etc.)
                          // clipboard => yaani wo jagah jaha "copy" kiya gaya data temporarily store hota hai.
                          //  writeText(...) => clipboard me text likhna — yaani copy karna
